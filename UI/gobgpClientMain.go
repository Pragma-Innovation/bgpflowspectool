...
func flowspecWin() {
	...
	regexpByteValueValidation = core.NewQRegExp2("(false|true|(2[0-5][0-5]|1[0-9][0-9]|[0-9][0-9]|[0-9])|([& ][<>]2[0-5][0-5]|[& ][<>]1[0-9][0-9]|[& ][<>][0-9][0-9]|[& ][<>][0-9])|([<>=! ]=2[0-5][0-5]|[<>=! ]=1[0-9][0-9]|[<>=! ]=[0-9][0-9]|[<>=! ]=[0-9])|([& ][<>=!]=2[0-5][0-5]|[& ][<>=!]=1[0-9][0-9]|[& ][<>=!]=[0-9][0-9]|[& ][<>=!]=[0-9])|([& ][<>]=2[0-5][0-5]|[& ][<>]=1[0-9][0-9]|[& ][<>]=[0-9][0-9]|[& ][<>]=[0-9])|([<>= ]2[0-5][0-5]|[<>= ]1[0-9][0-9]|[<>= ][0-9][0-9]|[<>= ][0-9]))*", core.Qt__CaseInsensitive, core.QRegExp__RegExp2)
	...
	regexpPckLenValidation = core.NewQRegExp2("(false|true|([& ][<>]2[0-5][0-5]|[& ][<>]1[0-9][0-9]|[& ][<>][0-9][0-9]|[& ][<>][0-9])|([<>=!]=2[0-5][0-5]|[<>=!]=1[0-9][0-9]|[<>=!]=[0-9][0-9]|[<>=!]=[0-9])|([& ][<>=!]=2[0-5][0-5]|[& ][<>=!]=1[0-9][0-9]|[& ][<>=!]=[0-9][0-9]|[& ][<>=!]=[0-9])|([& ][<>]=2[0-5][0-5]|[& ][<>]=1[0-9][0-9]|[& ][<>]=[0-9][0-9]|[& ][<>]=[0-9])|([<>= ]2[0-5][0-5]|[<>= ]1[0-9][0-9]|[<>= ][0-9][0-9]|[<>= ][0-9]))*", core.Qt__CaseInsensitive, core.QRegExp__RegExp2)
